...
import BtnUnderline from '../../components/BtnUnderline'
    ...
    <article className='bg-gray-bg md:bg-transparent align-middle grid grid-cols-auto lg:grid-cols-2 pb-[7.2rem] py-[3rem] md:py-[3rem] md:pt-[7rem] md:pb-[11rem] px-[2rem] sm:px-[4rem] xl:px-[11rem]'>
      <Fade direction='down' triggerOnce={true}>
        <section className='relative grid gap-5 mlg:gap-6'>
          ...
          <p className='leading-9 text-xl lg:text-2xl lg:leading-[40px] pb-[2rem]'>I'm Asley, a python and full stack developer based in Montréal, Canada. I love learning new stuff and creating pretty websites.</p>
