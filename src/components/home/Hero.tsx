...
const Hero = () => {
  return (
    <div className='bg-gray-bg md:bg-transparent grid grid-cols-auto lg:grid-cols-2 pb-[7.2rem] py-[3rem] md:py-[3rem] md:pt-[7rem] md:pb-[11rem] px-[2rem] sm:px-[4rem] xl:px-[11rem]'>
        <div className='relative grid gap-5 mlg:gap-6'>
