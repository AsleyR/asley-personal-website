      ...
      <Fade direction='up' triggerOnce={true}>
        <article className='grid grid-cols-[auto_min-content] items-center gap-0 md:gap-20 mt-16'>
          <section className='grid gap-5'>
            ...
            <p className='text-lg leading-9'>
              I work mostly with React and Express to make web apps, but for my other projects, I usually just work with Python to create small desktop programs using the PySimpleGui library if the need for a Gui arises. 
            </p>
          </section>
